...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Platformer Game", WIDTH / 2, HEIGHT / 2, arcade.color.BLACK, font_size=50, anchor_x= "center")
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Press Esc. to pause", WIDTH / 2, HEIGHT - 100, arcade.color.BLACK, font_size=20,anchor_x="center")
